...
namespace OTAGRUM {
    ...
    //void CorrectedMutualInformation::useNoCorr() {
        //clearCaches();
        //kmode_ = KModeTypes::NoCorr;
    //}

    //void CorrectedMutualInformation::useNaive() {
        //clearCaches();
        //kmode_ = KModeTypes::Naive;
    //}

    //void CorrectedMutualInformation::useGaussian() {
        //clearCaches();
        //cmode_ = CModeTypes::Gaussian;
    //}

    //void CorrectedMutualInformation::useBernstein() {
        //clearCaches();
        //cmode_ = CModeTypes::Bernstein;
    //}
    ...
    double CorrectedMutualInformation::computeCrossEntropy(const OT::Indices &variables,
                                                           const int K) {
        //std::cout << "Entering computeCrossEntropy" << std::endl;
        ...
        if (variables.getSize() > 1) {  // If there is more than one variable
            ...
            if (!HCache_.exists(key)) {  // if H(variables) haven't been computed
                ...
                //std::cout << "Marginal data: " << marginal_data << std::endl;
                double H = 0.;
                ...
                //std::cout << "Caching H(" << variables << ";" << K << ") = " << H << std::endl;
