  ...
  const Sample &sample) const
{
  ...
  for (UnsignedInteger i = 0; i < order.getSize(); ++i)
  {
    ...
    std::cerr << "i=" << i << ", globalIndex=" << globalIndex << ", indices=" << indices << std::endl;
    ...
    else
    {
      ...
      std::cerr << "Full indices=" << indices << std::endl;
      ...
      else
      {
        ...
        std::cerr << "learning sample size=" << localSample.getSize() << ", validation sample size=" << validationSample.getSize() << std::endl;
  ...
  std::cerr << "local distributions=" << localDistributions << std::endl;
